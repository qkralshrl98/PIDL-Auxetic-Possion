...
model = TabNetBaseline(input_dim=X_train.shape[1])
...
ckpt = ModelCheckpoint(
    filepath=os.path.join(RESULT_DIR, "tabnet_baseline_pretrained.h5"),
    monitor="val_mae",
    save_best_only=True,
...
model.load_weights(os.path.join(RESULT_DIR, "tabnet_baseline_pretrained.h5"))
