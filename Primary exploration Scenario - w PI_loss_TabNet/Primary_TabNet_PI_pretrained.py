...
class MonotonicTabNet(Model):
    def __init__(self, input_dim, cell_col_idx, margin=0.0, alpha=1.0,
                 n_steps=3, n_d=64, n_a=64, relaxation_factor=1.5):
        super().__init__()
...
for alpha in ALPHA_LIST:
    ...
    model_tmp = MonotonicTabNet(input_dim=X_train.shape[1], cell_col_idx=cell_idx,
...
model_best = MonotonicTabNet(input_dim=X_train.shape[1], cell_col_idx=cell_idx,
